...
class ViewController2: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        subtitulo.text = "Você tirou um tempo para cuidar de si mesma? Como foi essa experiência?"
        ...
        opcao1.setTitle("😆 \n Sim! Fiz coisas que me acalmam para equilibrar \ncom a rotina cansativa. \n Não preciso de ajuda.", for: .normal)
        ...
        opcao2.setTitle("😊 \n Sim, mas não tirei muito tempo necessário para descansar. \n Preciso de um pouco de ajuda.", for: .normal)
        ...
        opcao4.setTitle("😢 \n Não deu tempo, a minha rotina foi muito corrida. \n Preciso de muita ajuda.", for: .normal)
    ...
    func updateContador(valor: Int){
        delegate?.didSelect(weight: valor, index: 1)
    }
}
