...
class ViewController3: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        subtitulo.text = "Você conseguiu seguir um cronograma alimentar hoje?"
        ...
        opcao3.setTitle("😕 \n Não consegui! Minha rotina foi composta por carboidratos e com alto índice de açúcar. \n Preciso de ajuda.", for: .normal)
        ...
        opcao4.setTitle("😢 \n Não consegui! Minha rotina foi composta por alimentos com alto índice de açúcar. \n Preciso de muita ajuda.", for: .normal)
    ...
    func updateContador(valor: Int){
        delegate?.didSelect(weight: valor, index: 2)
    }
}
