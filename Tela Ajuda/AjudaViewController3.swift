...
class AjudaViewController3: UIViewController {
    
    let titulo = UILabel()
    let subtitulo = UILabel()
    let foto = UIImageView(image: #imageLiteral(resourceName: "progresso.png"))
    ...
    override func viewDidLoad() {
        ...
        subtitulo.text = "Após realizar a sua reflexão, você poderá visualizar seus resultados que serão apresentados em um gráfico personalizado."
