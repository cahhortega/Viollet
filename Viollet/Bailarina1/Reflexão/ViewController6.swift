...
class ViewController6: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        subtitulo.text = "Você criou um planejamento de tarefas hoje? Conseguiu cumprí-las?"
        ...
        opcao1.setTitle("😆 \n Fiz um planejamento e consegui cumprir minhas tarefas. \n Não preciso de ajuda.", for: .normal)
        ...
        opcao3.setTitle("😕 \n Não fiz um planejamento, mas consegui cumprir algumas tarefas. \n Preciso de ajuda.", for: .normal)
        ...
        opcao4.setTitle("😢 \n Não fiz um planejamento e não consegui realizar \nas tarefas programadas para hoje. \n Preciso de muita ajuda.", for: .normal)
    ...
    func updateContador(valor: Int){
        delegate?.didSelect(weight: valor, index: 5)
    }
}
