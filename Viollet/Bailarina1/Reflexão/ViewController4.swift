...
class ViewController4: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        subtitulo.text = "Ao se autoavaliar, você conseguiu organizar seus objetivos? Como você se sentiu?"
        ...
        opcao1.setTitle("😆 \n Sim! Consegui planejar tudo que quero fazer \n e me senti muito motivada. \n Não preciso de ajuda.", for: .normal)
        ...
        opcao2.setTitle("😊 \n Sim, consegui planejar minhas tarefas futuras, \n mas não me senti bem me organizando dessa forma. \n Preciso de um pouco de ajuda.", for: .normal)
        ...
        opcao3.setTitle("😕 \n Sim, consegui pensar em algumas motivações \n e objetivos, mas não me adaptei com o planejamento. \n Preciso de ajuda.", for: .normal)
        ...
        opcao4.setTitle("😢 \n Não consegui planejar minhas tarefas futuras, \n nem me organizar de acordo com meus objetivos. \n Preciso de muita ajuda.", for: .normal)
    ...
    func updateContador(valor: Int){
        delegate?.didSelect(weight: valor, index: 3)
    }
}
