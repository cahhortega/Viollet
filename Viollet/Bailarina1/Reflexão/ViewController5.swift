...
class ViewController5: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        subtitulo.text = "Você conseguiu executar todos os passos na aula de hoje?"
        ...
        opcao1.setTitle("😆 \n Sim! Executei tudo com muita facilidade. \n Não preciso de ajuda.", for: .normal)
        ...
        opcao2.setTitle("😊 \n Sim, porém com algumas dificuldades físicas. \n Preciso de um pouco de ajuda.", for: .normal)
        ...
        opcao3.setTitle("😕 \n Sim, porém tiveram alguns passos que não\n consegui executar por dificuldades físicas. \n Preciso de ajuda.", for: .normal)
        ...
        opcao4.setTitle("😢 \n Não consegui executar nada. Estou com dificuldades por causa da ausência de flexibilidade. \n Preciso de muita ajuda.", for: .normal)
    ...
    func updateContador(valor: Int){
        delegate?.didSelect(weight: valor, index: 4)
    }
}
